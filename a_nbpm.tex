...
\begin{figure}
	\centering
  \includegraphics[width=1\linewidth, max width=.45\linewidth]{hist1518_ONLYQUADS_01}
	
  \includegraphics[width=1\linewidth, max width=.45\linewidth]{hist1518_NAIV_01}
	\caption{Left: Difference between the real (simulated) horizontal $\beta$-functions and the ones
    ...
    Right: The same quantities are evaluated for
...
\begin{figure}
	\centering
  \includegraphics[width=.5\linewidth]{hist1518_EVERYTHING_01}
