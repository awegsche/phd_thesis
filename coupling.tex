...
Figure~\ref{fig_comp_felix_ryo} shows the comparison between the three methods. Formula and model methods reconstruct the f~term well but a jump occurs at the position of the AC-dipole. 