...
The AC-dipole inflicts a kick on the particle, \eqref{eq_ackick}, exactly like a quadrupole in thin-lens
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.49\linewidth]{forcedcoupling/ac_outside}
  \includegraphics[width=.49\linewidth]{forcedcoupling/ac_outside_at_loc}
  \caption{Comparison of the three methods with a coupling bump in the lattice.
    ...
    The right plot shows the location of the AC-dipole. The jump is negligible.
  }
...
the jump at the location of the AC-dipole is negligibly small. The formula method and the new method show a good
