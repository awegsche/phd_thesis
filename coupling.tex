...
Figure~\ref{fig_comp_felix_ryo} shows the comparison between the three methods. Formula and model methods reconstruct the coupling term $f_{1001}$ well but a jump occurs at the position of the AC-dipole. This jump can be reconstructed by the new formula. The overall agreement, for all three methods is still 