...
\begin{figure}[h]
  ...
  \caption{Comparison of the three methods with the AC-dipole surrounded by a coupling bump.
    ...
    line. The offset between \emph{meas} and the reconstructed values is due to the reconstruction
...
The jump at the position of the AC-dipole is well reproduced.
