...
\begin{align}
    h_{y,x}(s,N) = 
        ...
        \Bigg\} \notag \\
    %&=
    %\frac{A_\theta}{4\sin\left[\pi(Q_x +Q_y^d)\right]} 
    %\notag \\ &\quad \times
    %\left(
        %\e{i\left[ \varphi_{s_ds} + (Q_x+Q_y^d)(2N + \text{sgn}(s-s_d))\right]}
        %+\lambda_c\e{i\left[ \varphi_{s_ds} + (Q_x-Q_y^d)(2N + \text{sgn}(s-s_d))\right]}
    %\right)
\end{align}
%
%
...
\begin{align}
    ...
    + f^*_{1001} \frac{A_\theta}{4\sin\left[ \pi(Q_x-Q_y^d) \right]}
        ...
        \notag \\
   %     &=
   % {f^{d*}_{1001}}\frac{A_\theta}{4 \sin(\pi Q_x^-)}
   %     \e{-i\left[ \varphi^d + \pi Q_x^- \text{sgn}(s-s_d)\right]}
   %     \notag \\ &\quad
   % {f^{d*}_{1001}}\frac{A_\theta}{4 \sin(\pi Q_x^-)}
   %     \e{-i\left[ \varphi^d + \pi Q_x^- \text{sgn}(s-s_d)\right]}
   %     \frac{
