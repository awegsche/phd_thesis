...
\begin{figure}[h]
  \centering
  \includegraphics[width=.49\linewidth]{forcedcoupling/thesis_ac_outside}
  \includegraphics[width=.49\linewidth]{forcedcoupling/thesis_ac_outside}
...
The AC-dipole is located at $s=\SI{10000}{m}$ in a region with low coupling. 
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.7\linewidth]{thesis_abs}
