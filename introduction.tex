...
%
\begin{equation}
    \Delta h_z(N) = i A_\theta\beta(s_d) \cos(2\pi i \Qd{z} N)
\end{equation}
%
...
$\beta$, $\alpha$ and $\phi$\footnote{Ryoichi Miyamoto, private communication, Feb. 2017}.
...
%
\begin{align}
  h_z^+(s,n) =&\: \frac{A_\theta\beta(s_d)}{4\sin(\pi Q_z^-)}
