...
\begin{figure}
  ...
  \caption{
    ...
    If the model phase advance between two BPMs is exactly $\pi$, the effect is the same and the
...
\end{figure}
%
Figure~\ref{fig_local_error} illustrates the effect of a single focusing error on the RDT.
